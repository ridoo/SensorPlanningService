...
import org.n52.sps.sensor.config.exec.CiteTaskScheduler;
import org.n52.sps.sensor.config.exec.CiteTaskSimulation;
import org.n52.sps.sensor.config.tasking.TextValuesDataRecordValidator;
...
public class SmlConfigActuator extends SensorPlugin {

	private static final Logger LOGGER = LoggerFactory.getLogger(SmlConfigActuator.class);
	
    public SmlConfigActuator(SensorTaskService sensorTaskService, SensorConfiguration configuration) throws InternalServiceException {
    ...
    public boolean isDataAvailable() {
        return false; // config changes do not generate data
    }
